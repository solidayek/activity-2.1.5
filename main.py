...
decrypted = use_key((16789, 3305),'6058-1695-6053-7708-0403-15302-16447-0331-4737-8780-10535-3625-8375-10353-0363-9343-10198-10431-1702-10600-10759-7378')
plain_message = denumerize(decrypted)
print(plain_message)




decrypted_two = use_key((11663,7),'1416-8046-11505-9508-8934-9774-10475-3125-4218-9198-10490-11037-8203-6995-1595-5970-8185-4127-9477-7237'
)
plain_messageTwo = denumerize(decrypted_two)
print(plain_messageTwo)